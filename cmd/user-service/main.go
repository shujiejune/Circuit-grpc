...
import (
	...
	pb "dispatch-and-delivery/pkg/proto/user" // Import the generated protobuf package
...
func main() {
	...
	cfg, err := config.LoadConfig(".") // Assuming .env is in the root
	if err != nil {
	...
	userService := users.NewService(userRepo, nil, nil, cfg.JWTSecret, "", nil)
